...
<div class="row middle-row">
	<div class="middle_container book">
		<div class="inputs">
			<table class="input_table" id="book_work_input">
				<thead>
					<tr>
						<th class="option">
              Media &<br/>
              ...
              Expected Wastage
						...
						<th class="finish_size_format">
							Finish Size <br/>(Cut Size) <br/>Format
						</th>
						<th class="total_pgs">
            ...
            <td class="front_colors hide">
            </td>
            <td class="back_colors hide">
            </td>
						<td class="plate_cost">
							<input></input>
						</td>
              ...
              <select class="min_print_charges">
                ...
                <option value="3000">3000 Impressions</option>
						...
						<td class="pages_in_plate_sig">
							<input></input>
              <select class="inner_pgs_printed hide">
                <option value="">Select</option>
                <option value="1" selected>Inner Title Pages (2&3) Printed</option>
                <option value="2">Inner Title Pages (2&3) Blank</option>
              </select>
              <div class="inner_pgs_printed_div">
                <i class="fa-solid fa-caret-down"></i>
                <div class="row selected" value="1">
                  Inner Title Pages (2&3) Printed
                </div>
                <div class="row" value="2">
                  Inner Title Pages (2&3) Blank
                </div>
              </div>
						</td>
						<td class="ups_in_plate">
	...
	<div class="results hide">
		<div class="div-3 result_div">
          ...
          <img src="images/arrow_drop_down.svg">
			...
			<div class="row paper-wstg">
				<div class="title">
					TITLE CARD/ PAPER+WSTG
          <img src="images/arrow_drop_down.svg">
				</div>
				<div class="title-paper-a res-1">
				</div>
				<div class="title-paper-b res-2">
				</div>
				<div class="title-paper-c res-3">
				</div>
			</div>
			<div class="row">
				<div class="title">
					INNER PAGES DTP/DESIGN
				</div>
			...
			<div class="row">
				...
				<div class="title-design-a res-1">
				</div>
				<div class="title-design-b res-2">
				</div>
				<div class="title-design-c res-3">
				</div>
			</div>
			<div class="row">
				<div class="title">
					INNER PGS PLATE + MIN. PRNTG.
				</div>
		...
		<div class="div-3 result_div">
			...
			<div class="row">
				<div class="title">
					TITLE PLATE + MIN. PRNTG.
				</div>
				<div class="title-plate-a res-1">
				</div>
				<div class="title-plate-b res-2">
				</div>
				<div class="title-plate-c res-3">
				</div>
			</div>
			<div class="row">
				<div class="title">
					INNER PGS BALANCE QTY PRTNG.
				</div>
			...
			<div class="row">
				<div class="title">
					TITLE BALANCE QTY PRTNG.
				</div>
				<div class="title-print-a res-1">
				</div>
				<div class="title-print-b res-2">
				</div>
				<div class="title-print-c res-3">
				</div>
			</div>
			<div class="row">
				<div class="title">
