...
<div class="row middle-row">
	<div class="single_sheet middle_container">
		<div class="inputs">
			<table id="single_sheet_input" class="input_table">
				<thead>
					<tr>
            <th class="option hide">
              ...
              Expected Wastage
						...
						<th class="pages_in_plate_sig">
							Pages (UPs)<br/>In Plate<br/> Signa-<br/>ture
						</th>
						<th class="num_colors">
							Number of Colors 
						</th>
              ...
              Printing<br/>
				...
				<tbody id="inputs_rows">
					<tr>
						...
						<td class="paper">
              <input class="selectPaper" readonly="readonly" 
	...
	<div class="results row hide">
		...
		<div class="div-3 result_div single_sheet">
			<div class="row">
				<div class="title">
					DETAILS
				</div>
